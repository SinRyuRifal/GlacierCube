 ...
 * @author Rifal
 */
public class Dialog_DataKaryawan extends javax.swing.JDialog {
private boolean karyawanSelected = false;
    ...
    public Dialog_DataKaryawan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Dialog_DataKaryawan dialog = new Dialog_DataKaryawan(new javax.swing.JFrame(), true);
