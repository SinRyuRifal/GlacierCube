 ...
 * @author Rifal
 */
public class Dialog_DataOperator extends javax.swing.JDialog {
private boolean karyawanSelected = false;
    ...
    private void autoResizeAllColumns() {
      ...
      private void loadData() {
        ...
        mesinModel.addColumn("ID Karyawan");
        mesinModel.addColumn("Nama Karyawan");
        mesinModel.addColumn("Divisi");

        tbl_karyawandialog.setAutoCreateRowSorter(true); 
        autoResizeAllColumns(); 

        try {
            String sql = "SELECT * FROM karyawan WHERE Divisi = 'Operator'";
        ...
        ResultSet rs = pst.executeQuery();
            ...
            tbl_karyawandialog.setModel(mesinModel);
    ...
    public Dialog_DataOperator(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void changedUpdate(DocumentEvent e) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Dialog_DataOperator dialog = new Dialog_DataOperator(new javax.swing.JFrame(), true);
