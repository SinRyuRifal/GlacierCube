...
public class GrafikGajian extends javax.swing.JFrame {

    
    public GrafikGajian() {
        initComponents();
        chart.setTitle("Chart Data");
        chart.addLegend("Gaji Dibayarkan", Color.decode("#7b4397"), Color.decode("#dc2430"));
        setDataPesan();
    }
...
"ORDER BY TO_CHAR(\"tanggalgajian\", 'MMYYYY') DESC, TO_CHAR(\"tanggalgajian\", 'Month') DESC";
        ...
        while (r.next()) {
            ...
            double amount = r.getDouble("Gaji Dibayarkan");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GrafikGajian().setVisible(true);
            }
        });
    }
