...
public class GrafikProduksi extends javax.swing.JFrame {

    
    public GrafikProduksi() {
        initComponents();
        chart.setTitle("Chart Data");
        chart.addLegend("Jumlah Produksi", Color.decode("#7b4397"), Color.decode("#dc2430"));
        setDataPesan();
    }
...
"ORDER BY TO_CHAR(\"tglproduksi\", 'MMYYYY') DESC, TO_CHAR(\"tglproduksi\", 'Month') DESC";
        ...
        while (r.next()) {
            ...
            double amount = r.getDouble("Jumlah Produksi");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GrafikProduksi().setVisible(true);
            }
        });
    }
