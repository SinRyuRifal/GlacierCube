 ...
 * @author raven
 */
public class PieChartBahan extends javax.swing.JFrame {

    /**
     * Creates new form Test
     */
    public PieChartBahan() {
        initComponents();
    ...
    private void showYear() throws SQLException {
        String sql = "SELECT EXTRACT(YEAR FROM TGLPEMBELIAN) AS yearNumber\n" +
"FROM PEMBELIAN GROUP BY yearNumber";
    ...
    private void showMonth(int year) throws SQLException{
     String sql = "SELECT\n" +
"    TO_CHAR(TGLPEMBELIAN, 'Month') AS monthText,\n" +
"    EXTRACT(MONTH FROM TGLPEMBELIAN) AS monthNumber\n" +
"FROM\n" +
"    PEMBELIAN\n" +
"WHERE\n" +
"    EXTRACT(YEAR FROM TGLPEMBELIAN) = ?\n" +
"GROUP BY\n" +
"    monthNumber, monthText";
   ...
   private void showData(int year, int month) {
    try {
        ...
        String sql = "SELECT\n" +
                     "    BAHANBAKU.NAMABAHAN,\n" +
                     "    SUM(DETAILPEMBELIAN.SUBTOTALPEMBELIAN) AS TotalPembelian\n" +
                     "FROM\n" +
                     "    PEMBELIAN\n" +
                     "    JOIN DETAILPEMBELIAN ON PEMBELIAN.IDPEMBELIAN = DETAILPEMBELIAN.IDPEMBELIAN\n" +
                     "    JOIN BAHANBAKU ON DETAILPEMBELIAN.IDBAHAN = BAHANBAKU.IDBAHAN\n" +
                     "WHERE\n" +
                     "    EXTRACT(YEAR FROM PEMBELIAN.TGLPEMBELIAN) = ?\n" +
                     "    AND EXTRACT(MONTH FROM PEMBELIAN.TGLPEMBELIAN) = ?\n" +
                     "GROUP BY\n" +
                     "    BAHANBAKU.NAMABAHAN\n" +
                     "ORDER BY\n" +
                     "    BAHANBAKU.NAMABAHAN;";
        ...
        while (r.next()) {
            String namaBahan = r.getString(1);
            double values = r.getDouble(2);
            pieChart1.addData(new ModelPieChart(namaBahan, values, getColor(index++)));
        }
   ...
   public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PieChartBahan().setVisible(true);
            }
        });
    }
