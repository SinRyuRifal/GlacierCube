...
public class GrafikProdukTerjual extends javax.swing.JFrame {

    
    public GrafikProdukTerjual() {
        initComponents();
        chart.setTitle("Chart Data");
        chart.addLegend("Produk Terjual", Color.decode("#7b4397"), Color.decode("#dc2430"));
        setDataPesan();
    }
...
"       SUM(totalpesanan) AS \"Produk Terjual\"\n" +
"FROM pesanan\n" +
...
"ORDER BY TO_CHAR(\"tglpesanan\", 'MMYYYY') DESC, TO_CHAR(\"tglpesanan\", 'Month') DESC";
        ...
        while (r.next()) {
            ...
            double amount = r.getDouble("Produk Terjual");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GrafikProdukTerjual().setVisible(true);
            }
        });
    }
