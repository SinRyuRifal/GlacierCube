...
public class GrafikTotalGajian extends javax.swing.JFrame {

    
    public GrafikTotalGajian() {
        initComponents();
        chart.setTitle("Chart Data");
        chart.addLegend("Total Gaji", Color.decode("#7b4397"), Color.decode("#dc2430"));
        setDataPesan();
    }
 ...
 public void setDataPesan() {
       try {
        ...
        String sql = "SELECT TO_CHAR(\"tanggalgajian\", 'Month') AS \"Month\",\n" +
"       SUM(gajibersih) AS \"Total Gaji\"\n" +
"FROM transaksigaji\n" +
"WHERE EXTRACT(YEAR FROM \"tanggalgajian\") = ?\n" +
"GROUP BY TO_CHAR(\"tanggalgajian\", 'MMYYYY'), TO_CHAR(\"tanggalgajian\", 'Month')\n" +
"ORDER BY TO_CHAR(\"tanggalgajian\", 'MMYYYY') DESC, TO_CHAR(\"tanggalgajian\", 'Month') DESC";
        ...
        while (r.next()) {
            ...
            double amount = r.getDouble("Total Gaji");
     ...
     */
     public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GrafikTotalGajian().setVisible(true);
            }
        });
    }
