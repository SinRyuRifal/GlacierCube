...
public class GrafikPesanan extends javax.swing.JFrame {

    
    public GrafikPesanan() {
        initComponents();
        chart.setTitle("Chart Data");
        chart.addLegend("Jumlah Pesanan", Color.decode("#7b4397"), Color.decode("#dc2430"));
        setDataPesan();
    }
...
"ORDER BY TO_CHAR(\"tglpesanan\", 'MMYYYY') DESC, TO_CHAR(\"tglpesanan\", 'Month') DESC";
        ...
        while (r.next()) {
            ...
            double amount = r.getDouble("Jumlah Pesanan");
     ...
     */
     public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GrafikPesanan().setVisible(true);
            }
        });
    }
