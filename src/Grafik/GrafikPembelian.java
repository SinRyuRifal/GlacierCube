...
public class GrafikPembelian extends javax.swing.JFrame {

    
    public GrafikPembelian() {
        initComponents();
        chart.setTitle("Chart Pembelian");
        chart.addLegend("Jumlah Pembelian", Color.decode("#7b4397"), Color.decode("#dc2430"));
        setDataBeli();
    }

   public void setDataBeli() {
        try {
            ...
            if (optionYear == JOptionPane.OK_OPTION) {
                ...
                while (r.next()) {
                    ...
                    double amount = r.getDouble("Jumlah Pembelian");
     ...
     */
     public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GrafikPembelian().setVisible(true);
            }
        });
    }
