...
public class GrafikTotalPemasukan extends javax.swing.JFrame {

    
    public GrafikTotalPemasukan() {
        initComponents();
        chart.setTitle("Chart Data");
        chart.addLegend("Total Pemasukan", Color.decode("#7b4397"), Color.decode("#dc2430"));
        setDataPesan();
    }
 ...
 public void setDataPesan() {
       try {
        ...
        List<ModelDataPesanan> lists = new ArrayList<>();
        DatabaseConnection.getInstance().connectToDatabase();
      String sql = "SELECT TO_CHAR(\"tglpesanan\", 'Month') AS \"Month\",\n"
            + "       SUM(totalhargapesanan) AS \"Total Pemasukan\"\n"
            + "FROM pesanan\n"
            + "WHERE EXTRACT(YEAR FROM \"tglpesanan\") = ?\n"
            + "      AND statuspesanan = 'Lunas'\n"
            + "GROUP BY TO_CHAR(\"tglpesanan\", 'MMYYYY'), TO_CHAR(\"tglpesanan\", 'Month')\n"
            + "ORDER BY TO_CHAR(\"tglpesanan\", 'MMYYYY') DESC, TO_CHAR(\"tglpesanan\", 'Month') DESC";
        ...
        while (r.next()) {
            ...
            double amount = r.getDouble("Total Pemasukan");

            lists.add(new ModelDataPesanan(month, amount));
        }
        r.close();
        p.close();
        ...
        if (lists.size() == 1) {
            ...
            for (int i = lists.size() - 1; i >= 0; i--) {
                ModelDataPesanan d = lists.get(i);
     ...
     */
     public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GrafikTotalPemasukan().setVisible(true);
            }
        });
    }
