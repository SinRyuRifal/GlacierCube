...
public class GrafikBahanDibeli extends javax.swing.JFrame {

    
    public GrafikBahanDibeli() {
        initComponents();
        chart.setTitle("Chart Data");
        chart.addLegend("Bahan Dibeli", Color.decode("#7b4397"), Color.decode("#dc2430"));
        setDataPesan();
    }
...
"       SUM(totalPembelian) AS \"Bahan Dibeli\"\n" +
"FROM pembelian\n" +
...
"ORDER BY TO_CHAR(\"tglpembelian\", 'MMYYYY') DESC, TO_CHAR(\"tglpembelian\", 'Month') DESC";
        ...
        while (r.next()) {
            ...
            double amount = r.getDouble("Bahan Dibeli");
   ...
   public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GrafikBahanDibeli().setVisible(true);
            }
        });
    }
